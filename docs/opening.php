...
<body class="text-gray-800">
        ...
        <main>
            ...
            <div class="glass-card p-8 text-center mb-8">
                <div class="max-w-2xl mx-auto">
                    ...
                    <h2 class="text-3xl font-bold text-blue-800 mb-4">Selamat Datang di Sistem Pakar Diagnosis Diabetes</h2>
                    <p class="text-blue-700 mb-6">
                        Sistem ini akan membantu Anda melakukan pemeriksaan awal terhadap kemungkinan diabetes berdasarkan gejala yang Anda alami. 
                        Diagnosis ini bersifat prediktif dan tidak menggantikan pemeriksaan dokter.
                    </p>
                    <div class="grid md:grid-cols-3 gap-6 mb-8">
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <i class="fas fa-clipboard-list text-2xl text-blue-600 mb-3"></i>
                            <h3 class="font-semibold text-blue-800 mb-2">Identifikasi Gejala</h3>
                            <p class="text-sm text-gray-600">Pilih gejala yang Anda alami</p>
                        </div>
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <i class="fas fa-chart-line text-2xl text-blue-600 mb-3"></i>
                            <h3 class="font-semibold text-blue-800 mb-2">Analisis Cepat</h3>
                            <p class="text-sm text-gray-600">Sistem menganalisis gejala Anda</p>
                        </div>
                        <div class="bg-white p-4 rounded-lg shadow-sm">
                            <i class="fas fa-file-medical text-2xl text-blue-600 mb-3"></i>
                            <h3 class="font-semibold text-blue-800 mb-2">Hasil & Rekomendasi</h3>
                            <p class="text-sm text-gray-600">Dapatkan laporan dan saran</p>
                        </div>
                    </div>
                    <a href="index.php" class="btn-primary text-white px-8 py-3 rounded-lg font-semibold text-lg flex items-center justify-center mx-auto w-fit">
                        Mulai Diagnosis <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                </div>
            </div>
            </div>
    ...
    <script>
        ...
        function startDiagnosis() {
            document.querySelector('#stepProgress').classList.remove('hidden');
            document.querySelector('.glass-card.p-8').classList.add('hidden');
            
            // Update progress bar
            document.querySelector('.progress-fill').style.width = '33%';
            
            // Update step indicator
            const step1 = document.querySelectorAll('.flex.items-center')[0];
            step1.querySelector('div').classList.remove('bg-blue-200');
            step1.querySelector('div').classList.add('bg-blue-600', 'text-white');
            step1.querySelector('span').classList.remove('text-blue-400');
            step1.querySelector('span').classList.add('text-blue-800');
        }
        ...
        function restartProcess() {
            ...
            document.querySelector('.glass-card.p-8').classList.remove('hidden');
